...
def find_MAP(
    ...
    **kwargs
    ...
    find_MAP should not be used to initialize the NUTS sampler. Simply call pymc3_ext.sample() and it will automatically initialize NUTS in a better way.
    ...
    *args, **kwargs
    ...
    wrapped it inside pymc3_ext.sample() and you should thus avoid this method.
    """
