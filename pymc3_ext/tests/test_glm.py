...
import pymc3_ext
from pymc3_ext import Model, Uniform, Normal, find_MAP, Slice, sample
from pymc3_ext import families, GLM, LinearComponent
import pandas as pd
...
class TestGLM(SeededTest):
    ...
    def test_glm_formula_from_calling_scope(self):
        ...
        GLM.from_formula("y ~ x + z", df, family=pymc3_ext.glm.families.Binomial())
