...
from pymc3_ext.sampling import assign_step_methods, sample
from pymc3_ext.parallel_sampling import ParallelSamplingError
from pymc3_ext.exceptions import SamplingError
from pymc3_ext.model import Model
from pymc3_ext.step_methods import (
    NUTS,
...
from pymc3_ext.distributions import Binomial, Normal, Bernoulli, Categorical, Beta, HalfNormal
...
class TestStepMethods:  # yield test doesn't work subclassing object
    ...
    def check_trace(self, step_method):
        ...
        ```
        BENCHMARK=100000 ./scripts/test.sh -s pymc3_ext/tests/test_step.py:TestStepMethods
        ```
