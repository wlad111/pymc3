...
import numpy as np
from pymc3_ext.backends import base
from pymc3_ext.backends.base import MultiTrace
from pymc3_ext.model import Model
from pymc3_ext.exceptions import TraceDirectoryError
...
def load_trace(directory: str, model=None) -> MultiTrace:
    ...
    ----------
    directory : str
        Path to a pymc3_ext serialized trace
