...
import numpy as np
import logging
from pymc3_ext.model import modelcontext, Point
from pymc3_ext.step_methods import arraystep
from pymc3_ext.step_methods.hmc import integration
from pymc3_ext.theanof import inputvars, floatX
from pymc3_ext.tuning import guess_scaling
from .quadpotential import quad_potential, QuadPotentialDiagAdapt
from pymc3_ext.step_methods import step_sizes
from pymc3_ext.backends.report import SamplerWarning, WarningType
...
class BaseHMC(arraystep.GradientSharedStep):
    ...
    def __init__(
        ...
        **theano_kwargs
        ...
        model : pymc3_ext Model instance
